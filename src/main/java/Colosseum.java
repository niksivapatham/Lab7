...
public class Colosseum {
     ...
     * max hit points.
     */
    public static final int MAX_HIT = 50;
    ...
    public static Pokemon buildPokemon() {
        ...
        tempPokemon.setStats(attack, defense);
        return tempPokemon;
    }
    ...
    public static void determineWinner() {
        ...
        } else if (secondPokemon.hitPoints == 0 && secondPokemon.hitPoints > 0) {
